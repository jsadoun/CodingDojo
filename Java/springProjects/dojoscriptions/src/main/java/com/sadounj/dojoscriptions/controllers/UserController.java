package com.sadounj.dojoscriptions.controllers;
...
import com.sadounj.dojoscriptions.services.PackageService;
import com.sadounj.dojoscriptions.services.UserService;
import com.sadounj.dojoscriptions.validator.UserValidator;
...
public class UserController {
	...
	public String joinPackage(Model model, Principal principal, @RequestParam(value="dueOn") Long dueOn, @RequestParam(value="choosePackage") Long id) {
		...
		Optional<DojoPackage> choose = packService.readOne(id);
