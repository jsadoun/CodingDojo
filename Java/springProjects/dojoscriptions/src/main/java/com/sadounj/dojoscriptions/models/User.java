package com.sadounj.dojoscriptions.models;
...
public class User {
	...
	public Optional<DojoPackage> getUserpackage() {
		return userpackage;
	}
	public void setUserpackage(Optional<DojoPackage> choose) {
		this.userpackage = choose;
	}
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name="package_id")
	private Optional<DojoPackage> userpackage;
